...
export default function DashboardClient({ permits }: Props) {
  ...
  if (permits.length === 0) {
    return (
      <div className="px-4 pt-8 pb-4 space-y-8 max-w-md mx-auto">
        {/* CTA */}
        <div className="text-center space-y-3 pt-4">
          <div className="text-5xl">📋</div>
          <div>
            <h2 className="text-xl font-bold text-stone-900">No permits yet</h2>
          ...
          <Link
            href="/permits/new"
            className="inline-block bg-amber-400 hover:bg-amber-500 active:bg-amber-600 text-stone-900 font-bold py-4 px-8 rounded-2xl transition-colors text-base mt-2 shadow-sm"
          >
        ...
        {/* Sample permit card */}
        <div>
          <p className="text-xs font-bold text-stone-400 tracking-widest uppercase mb-3 text-center">
            Here&apos;s what your board will look like
          </p>
          <div className="rounded-2xl border-2 border-red-400 bg-red-50 p-4 space-y-3 opacity-60 pointer-events-none select-none shadow-sm">
            <div className="flex items-start justify-between gap-2">
              <div>
                <div className="flex items-center gap-2">
                  <span className="text-sm">🔴</span>
                  <h3 className="font-bold text-stone-900 text-base">123 Oak Ave</h3>
                </div>
                <p className="text-base text-stone-600 mt-0.5">Electrical · #E-2411-24</p>
              </div>
              <span className="text-blue-600 text-xl">›</span>
            </div>
            <p className="text-base text-stone-700">Rough-in not called — 8 days since issued</p>
            <p className="text-sm text-stone-500">Expires Jun 14, 2025</p>
            <div className="w-full bg-amber-400 text-stone-900 font-bold py-3 px-4 rounded-xl text-base text-center">
